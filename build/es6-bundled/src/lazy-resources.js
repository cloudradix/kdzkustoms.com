...
</custom-style>`;template$1.setAttribute("style","display: none;");document.head.appendChild(template$1.content);(0,_shopApp.Polymer)({is:"paper-icon-button",_template:_shopApp.html$1`
    <style>
      :host {
...
</dom-module>`;document.head.appendChild($_documentContainer.content);const template$2=_shopApp.html$1`
...
`;template$2.setAttribute("strip-whitespace","");(0,_shopApp.Polymer)({_template:template$2,is:"paper-spinner-lite",behaviors:[PaperSpinnerBehavior]});const $_documentContainer$1=document.createElement("template");$_documentContainer$1.innerHTML=`<iron-iconset-svg style="display:none" name="icons" size="24">
<svg><defs>
