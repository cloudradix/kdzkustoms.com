...
</custom-style>`;template$1.setAttribute("style","display: none;");document.head.appendChild(template$1.content);Polymer({is:"paper-icon-button",_template:html`
    <style>
      :host {
...
</dom-module>`;document.head.appendChild($_documentContainer.content);const template$2=html`
...
`;template$2.setAttribute("strip-whitespace","");Polymer({_template:template$2,is:"paper-spinner-lite",behaviors:[PaperSpinnerBehavior]});const $_documentContainer$1=document.createElement("template");$_documentContainer$1.innerHTML=`<iron-iconset-svg style="display:none" name="icons" size="24">
<svg><defs>
